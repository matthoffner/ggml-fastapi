...
ENV MODEL_NAME="falcon-40b-instruct"
ENV DEFAULT_MODEL_TYPE="ggmlv3"
ENV DEFAULT_MODEL_FILE="${MODEL_NAME}.${DEFAULT_MODEL_TYPE}.q4_K_S.bin"
ENV MODEL_USER="TheBloke"
ENV DEFAULT_MODEL_BRANCH="main"
ENV MODEL_URL="https://huggingface.co/${MODEL_USER}/${MODEL_NAME}-GGML/raw/${DEFAULT_MODEL_BRANCH}/${DEFAULT_MODEL_FILE}"
